...
<!-- @trace
source: improve-query-rerank-quality
updated: 2026-06-20
code:
  - src/wiki.js
tests:
...
<!-- @trace
source: harden-telegram-knowledge-sedimentation-responses
updated: 2026-06-21
code:
  - .env.example
  - docs/design.md
...
<!-- @trace
source: add-sedimentation-reply-command
updated: 2026-06-21
code:
  - src/wiki.js
  - packaging/hermes/skills/wiki/SKILL.md
...
<!-- @trace
source: add-wiki-assistant-orchestrator
updated: 2026-06-21
code:
  - .env.example
  - README.md
...
<!-- @trace
source: document-telegram-tool-router-contract
updated: 2026-06-22
code:
  - .env.example
  - README.md
